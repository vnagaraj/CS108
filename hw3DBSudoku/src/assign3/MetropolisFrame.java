...
public class MetropolisFrame extends JFrame {
	...
	private void setControls() {
		...
		panelAddSearch.setLayout(new BoxLayout(panelAddSearch, BoxLayout.Y_AXIS));
		panelAddSearch.add(addBtn);
		addBtn.setMinimumSize(srchBtn.getMinimumSize());
		panelAddSearch.add(srchBtn);
		addBtn.setAlignmentX(RIGHT_ALIGNMENT);
		addBtn.setSize(srchBtn.getWidth(), srchBtn.getHeight());
		srchBtn.setAlignmentX(RIGHT_ALIGNMENT);
		panelAddSearch.setLayout(new BoxLayout(panelAddSearch, BoxLayout.Y_AXIS));
		...
		panelCombo.setBorder(BorderFactory.createTitledBorder("Search Options"));
		panelCombo.add(popCombo);
		panelCombo.add(matchTypeCombo);
		panelCombo.add(Box.createVerticalGlue());
		panelAddSearch.add(panelCombo);
		
		//this.getContentPane().add(panelTextBox, BorderLayout.NORTH);
		add(panelTextBox,BorderLayout.NORTH);
		...
		add(panelAddSearch,BorderLayout.EAST);
		JPanel emptyPanel = new JPanel();
		this.getContentPane().add(emptyPanel, BorderLayout.SOUTH);
	}
