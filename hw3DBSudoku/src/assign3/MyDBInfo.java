...
public class MyDBInfo {
	...
	public static final String MYSQL_USERNAME = "ccs108vganapat";
	public static final String MYSQL_PASSWORD = "quibaexi";
	public static final String MYSQL_DATABASE_SERVER = "mysql-user.stanford.edu";
	public static final String MYSQL_DATABASE_NAME = "c_cs108_vganapat";
