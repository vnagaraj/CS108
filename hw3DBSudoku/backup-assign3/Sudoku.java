...
public class Sudoku {
	...
	public Sudoku(String text) {
		int[][] ints = Sudoku.stringsToGrid(text);
	...
	private void solveSoduku(Spot[][] spotArr, ArrayList<Spot> unAssignedSpots,
		...
		if (index == unAssignedSpots.size()) {
			...
			long timeOnSovle = endTime - this.startTime;
			this.totalTime = this.totalTime + timeOnSovle;
			int[][] ints = this.convSpotArrToIntArr(spotArr);
			/*Sudoku sudoku = new Sudoku(ints);
	...
	public long getElapsed() {
		return totalTime; // YOUR CODE HERE
	}
